...
module Proto.Google.Protobuf.Compiler.CodeGeneratorResponse exposing (File, decodeFile, defaultFile, encodeFile, fieldNumbersFile, jsonDecodeFile, jsonEncodeFile)
...
@docs File, decodeFile, defaultFile, encodeFile, fieldNumbersFile, jsonDecodeFile, jsonEncodeFile
...
jsonDecodeFile =
    Proto.Google.Protobuf.Compiler.Internals_.jsonDecodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__File
...
jsonEncodeFile =
    Proto.Google.Protobuf.Compiler.Internals_.jsonEncodeProto__Google__Protobuf__Compiler__CodeGeneratorResponse__File
