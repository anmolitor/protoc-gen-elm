...
module Proto.Google.Protobuf.FieldDescriptorProto exposing (Label(..), Type(..), decodeLabel, decodeType, defaultLabel, defaultType, encodeLabel, encodeType, fieldNumbersLabel, fieldNumbersType, fromInternalLabel, fromInternalType, toInternalLabel, toInternalType)
...
@docs Label, Type, decodeLabel, decodeType, defaultLabel, defaultType, encodeLabel, encodeType, fieldNumbersLabel, fieldNumbersType
@docs fromInternalLabel, fromInternalType, toInternalLabel, toInternalType
-}
