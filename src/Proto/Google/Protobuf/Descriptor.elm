...
{-| Default for GeneratedCodeInfo_Annotation. Should only be used for 'required' decoders as an initial value.
...
{-| Default for SourceCodeInfo_Location. Should only be used for 'required' decoders as an initial value.
...
{-| Default for UninterpretedOption_NamePart. Should only be used for 'required' decoders as an initial value.
...
{-| Default for EnumDescriptorProto_EnumReservedRange. Should only be used for 'required' decoders as an initial value.
...
{-| Default for DescriptorProto_ReservedRange. Should only be used for 'required' decoders as an initial value.
...
{-| Default for DescriptorProto_ExtensionRange. Should only be used for 'required' decoders as an initial value.
