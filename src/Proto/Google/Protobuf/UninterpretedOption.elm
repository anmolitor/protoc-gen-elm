...
module Proto.Google.Protobuf.UninterpretedOption exposing (NamePart, decodeNamePart, defaultNamePart, encodeNamePart, fieldNumbersNamePart, jsonDecodeNamePart, jsonEncodeNamePart)
...
@docs NamePart, decodeNamePart, defaultNamePart, encodeNamePart, fieldNumbersNamePart, jsonDecodeNamePart, jsonEncodeNamePart
...
-}
jsonDecodeNamePart : Json.Decode.Decoder NamePart
jsonDecodeNamePart =
    Proto.Google.Protobuf.Internals_.jsonDecodeProto__Google__Protobuf__UninterpretedOption__NamePart


{-| Encode a `NamePart` to JSON. Uses the canonical encoding described here: https://protobuf.dev/programming-guides/proto3/#json

-}
jsonEncodeNamePart : NamePart -> Json.Encode.Value
jsonEncodeNamePart =
    Proto.Google.Protobuf.Internals_.jsonEncodeProto__Google__Protobuf__UninterpretedOption__NamePart
