...
module Proto.Google.Protobuf.MethodOptions exposing (IdempotencyLevel(..), decodeIdempotencyLevel, defaultIdempotencyLevel, encodeIdempotencyLevel, fieldNumbersIdempotencyLevel, fromInternalIdempotencyLevel, toInternalIdempotencyLevel)
...
@docs fromInternalIdempotencyLevel, toInternalIdempotencyLevel
-}
